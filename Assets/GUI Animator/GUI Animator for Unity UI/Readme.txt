------------------------------------------------------------------
GUI Animator for Unity UI 1.1.0
------------------------------------------------------------------
	...
	Note:
		...
		ï Unity Editor does not generate Texture Atlas for Unity UI. More details, http://docs.unity3d.com/Manual/SpritePacker.html.
...
------------------------------------------------------------------ 
	...
	Version 1.1.0
		...
		ï Added; Position Loop animation as an Idle-animation.
